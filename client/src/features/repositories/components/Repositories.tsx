...
const Repositories = () => {
  ...
  return (
    <main className="min-h-full flex-1 overflow-y-auto bg-[radial-gradient(circle_at_top_right,_rgba(14,165,233,0.09),_transparent_34%),#020617] text-slate-100">
      <div className="mx-auto w-full max-w-6xl px-5 py-8 sm:px-8 lg:px-10">
        <header className="mb-8 flex flex-col gap-5 border-b border-slate-800/80 pb-7 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm leading-6 text-slate-400">
              Browse the repositories connected to your GitHub App and send one
              to PR Funnel for indexing.
            </p>
          </div>
          <div className="flex items-center gap-3 text-sm text-slate-400">
            ...
            <span>
              <strong className="text-slate-200">{repositories.length}</strong>{" "}
              connected{" "}
        ...
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 text-xs text-slate-500">
            <span className="size-1.5 rounded-full bg-emerald-400" /> Live from
            GitHub
          </div>
        </div>
